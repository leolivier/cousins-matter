...
up:
	ENVIRONMENT="docker-devt" docker compose up -d $(c)

up4run u4r:
	ENVIRONMENT="docker-devt" docker compose up -d postgres redis qcluster
...
mkmig:
	ENVIRONMENT="development" ./manage.py makemigrations
