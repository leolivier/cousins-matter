...
def check_followers(
  request, followed_object, followed_object_owner, followed_object_url, new_internal_object=None, author=None
):
  """
...
def do_check_followers(followed_object, followed_object_owner, followed_object_url, new_internal_object=None, author=None):
