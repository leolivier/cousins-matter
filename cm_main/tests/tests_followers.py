...
class TestFollowersMixin:
  ...
  def check_new_content_email(
    self, follower, sender, owner, followed_url, followed_object, created_object, created_content, expected_emails_count=1
  ):
  ...
  def check_followers_emails(self, follower, sender, owner, url, followed_object, created_object, created_content):
    ...
    self.check_new_content_email(follower, sender, owner, followed_url, followed_object, created_object, created_content)
