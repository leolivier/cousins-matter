...
class GeneralViewsTestCase(MemberTestCase):
  ...
  @patch("core.views.views_general.default_storage.open")
  ...
  def test_send_zipfile(self):
    ...
    from core.views.views_general import send_zipfile
...
class QHealthCheckTestCase(TestCase):
  @patch("core.views.views_general.async_task")
  @patch("core.views.views_general.result")
