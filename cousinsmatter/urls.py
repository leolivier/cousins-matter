...
urlpatterns = [
  ...
  path(
    "password/change/",
    auth_views.PasswordChangeView.as_view(template_name="members/login/password_change.html"),
  ...
  path(
    ...
    PasswordResetView.as_view(
      template_name="members/login/password_reset.html", html_email_template_name="members/email/password_reset_email.html"
    ),
    name="reset_password",
  ),
  path(
  ...
  path(
    ...
    auth_views.PasswordResetCompleteView.as_view(template_name="members/login/password_reset_complete.html"),
