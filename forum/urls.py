...
urlpatterns = [
    ...
    path("<int:pk>/<int:page_num>", views_post.PostDisplayView.as_view(), name="display_page"),
...
if settings.DEBUG:
  urlpatterns += [
    path("test/create_posts/<int:num_posts>", views_test.test_create_posts, name="test_create_posts"),
    path("test/create_replies/<int:num_replies>", views_test.test_create_replies, name="test_create_replies"),
    path("test/create_comments/<int:num_comments>", views_test.test_create_comments, name="test_create_comments"),
  ]
