...
def toggle_follow(request, pk):
    ...
    return followers.toggle_follow(
        request, post, post.first_message.author, post_url(pk)
    )
...
def check_followers_on_message(request, message):
    ...
    followers.check_followers(
        request, post, post.owner(), post_url(post.id), message, message.author
    )
...
def check_followers_on_comment(request, comment):
    ...
    followers.check_followers(
        request, post, post.owner(), post_url(post.id), comment, comment.author
    )
