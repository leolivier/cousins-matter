...
class BulkUploadPhotosForm(forms.Form):
    zipfile = forms.FileField(label=_('Zip file'), 
                              help_text=_('The zip file containing the photos to upload. All folders will be created as galleries and photos in these flders added to the galleries. All photos must be in folders.'),
