...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "union_place",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="Union Place"
                    ),
                ),
                (
                    "separation_date",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "birth_place",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="Birth Place"
                    ),
                ),
                (
                    "death_date",
                ...
                (
                    "death_place",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="Death Place"
                    ),
                ),
        ...
        migrations.AddIndex(
            model_name="person",
            index=models.Index(
                fields=["last_name"], name="genealogy_p_last_na_5cd12f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="person",
            index=models.Index(
                fields=["birth_date"], name="genealogy_p_birth_d_c5547a_idx"
            ),
        ),
    ]
