...
class Person(models.Model):
  ...
  def age(self):
    ...
    return (
      end_date.year - self.birth_date.year - ((end_date.month, end_date.day) < (self.birth_date.month, self.birth_date.day))
    )
...
class Family(models.Model):
  ...
  union_type = models.CharField(_("Union Type"), max_length=4, choices=UNION_TYPES, default="MARR")
