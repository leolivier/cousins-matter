...
class MemberTestCase(TestCase):
  ...
  test_avatar_jpg = os.path.join(settings.MEDIA_REL, settings.AVATARS_DIR, "test_avatar.jpg")
  test_mini_avatar_jpg = os.path.join(settings.MEDIA_REL, settings.AVATARS_DIR, "mini_test_avatar.jpg")
