...
def toggle_follow(request, pk):
    ...
    if followed == follower:
        ...
        messages.success(
            request,
            _("You are no longer following %(followed_name)s")
        ...
        messages.success(
            request,
            _("You are now following %(followed_name)s")
            % {"followed_name": followed_name},
        )
        ...
        message = _("%(follower_name)s is now following you!") % {
            "follower_name": follower_name
        }
        follower_url = request.build_absolute_uri(
            reverse("members:detail", args=[follower.id])
        )
