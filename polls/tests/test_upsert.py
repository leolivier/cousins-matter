...
class QuestionUpsertTest(PollTestMixin):
  ...
  def test_update_questions_view(self):
    ...
    """
    poll = self.create_poll("Test poll", "Test description")
    question = self.create_question(question_text="Test YN question", question_type=Question.YESNO_QUESTION, poll=poll)
    ...
    question = self.create_question(question_text="Test DT question", question_type=Question.DATE_QUESTION, poll=poll)
    ...
    question = self.create_question(question_text="Test OT question", question_type=Question.OPENTEXT_QUESTION, poll=poll)
