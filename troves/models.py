...
class Trove(models.Model):
  ...
  title = models.CharField(
    verbose_name="Title of the treasure (this will appear in the list)", null=False, blank=False, max_length=110
  )
  description = models.TextField(
    verbose_name=_("Description of the treasure (this will appear in the details)"), null=True, blank=True
  )
  picture = models.ImageField(
    upload_to=settings.TROVE_PICTURE_DIRECTORY, verbose_name=_("Treasure photo"), null=False, blank=False
  )
  thumbnail = models.ImageField(upload_to=settings.TROVE_THUMBNAIL_DIRECTORY, blank=True)
  file = models.FileField(upload_to=settings.TROVE_FILES_DIRECTORY, verbose_name=_("Treasure file"), blank=True, null=True)
